...
gamepkg="com.sunborn.girlsfrontline.en"
...
title=title=subprocess.run(["/usr/bin/xdotool","search", "--name",'Girls Frontline.*Genymotion',"getwindowname"],capture_output=True).stdout.decode('utf-8').strip()
